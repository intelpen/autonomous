...
if __name__ == "__main__":
    ...
    # added `yolo_outputs` to your graph. This set of 4 tensors is ready to be used as input by `yolo_eval` function.
    # Filtering boxes `yolo_outputs` gave you all the predicted boxes of `yolo_model` in the correct format.
    # Pperform filtering and select only the best boxes.
